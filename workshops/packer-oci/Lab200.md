...
On the machine where you created your public keypair, convert your public key to a .pem format, usable as an API key, by running:            

```
ssh-keygen -f packerkey -e -m pem > packerkey.pem
```
...
and should now commit your work on that file to your repository.
