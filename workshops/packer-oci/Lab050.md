# Packer Workshop - Trial Account Set Up

![](images/WorkshopHeader.png)

## Overview

What is Packer? What is a Custom Image vs. a Virtual Machine?

- Packer is an application from the Hashicorp corporation (creators of Terraform too).
- [Packer Documentation](https://www.packer.io)
- A Compute instance is a runtime instance of an image.  Images can be thought of a source disks used to boot instances, they can be provided by Oracle's marketplace, one of the standard 8 (or so) provided in OCI by default, or they can be custom.  


**Note:** 

## Introduction
In this lab we will obtain an Oracle Cloud Trial Account, create an ssh key pairs=, login into your Trial, create a VCN (Virtual Compute Network) and Compartment, this enables you to create a Custom Image in OCI from your laptop.
...
- SSH into the Custom image launched instance: Validate and investigate
...
**You are ready to proceed to [Lab 100](Lab100.md)**
