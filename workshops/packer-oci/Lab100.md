...
- Now you can **copy** one of the subnet's OCID to the _variables_ file from step 3 by using the *copy* link.  
  ...
  For consistantcy, you will use AD-1 (at the bottom).  You wont run into problems as long as you pick the matching subnet & AD (e.g AD2 with Subnet2
...
### **STEP 8 Windows**: Create SSH Key Pair (Windows client)
