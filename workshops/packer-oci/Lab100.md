...
Before you create the Compute instance that will let us install packer, you need to create an ssh key pair so you will be able to securely connect to the instance.
