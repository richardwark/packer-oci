...
Your git repository will be a *private* copy, however, we're using it for expediancy only, it's not a secure place to key credentials or OCIDs. 

<will add a security discussion later>
