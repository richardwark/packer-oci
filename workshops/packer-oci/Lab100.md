...
## Collect Packer Compartment's OCID ## 
  - Now you can copy the new compartments OCID to the variables.json file from step 3 by using the *copy* limk
...
## Collect Packer-build subnet OCID ## 
   ...
   - Now you can copy the one of the subnet's OCID to the variables.json file from step 3 by using the *copy* limk.  For consistantcy, we suggest AD-1 (at the bottom)
