...
- Create the baseline infrastructure to support a  Compute image, you'll create and learn about:
  ...
  - Security Lists
- Create and using an SSH key pair
- Comfort Using git & Github
...
Using git is very common for cloud development, it provides source control and management of software, configuration and documenation files.  For the purposes of this workshop, we'll make use of GitHub for its ability to store and edit a couple of files that we'll use in image creation.
...
-  **open** variables.json using the browser interface.  There, you should see:
